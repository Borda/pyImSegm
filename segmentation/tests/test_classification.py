...
CLASSIF_NAMES = tl_clf.create_classifiers().keys()
...
class TestClassification(unittest.TestCase):
    ...
    def test_classif_simple(self):
        ...
        for n in CLASSIF_NAMES:
            logging.info('created classif.: %s', n)
            clf = tl_clf.create_classifiers()[n]
    ...
    def test_classif_pipeline(self):
        ...
        for n in CLASSIF_NAMES:
            logging.info('created classif.: %s', n)
            clf, _ = tl_clf.create_classif_train_export(n, data_train, labels_train)
            self.classif_eval(clf, data_train, labels_train,
                              data_test, labels_test)
